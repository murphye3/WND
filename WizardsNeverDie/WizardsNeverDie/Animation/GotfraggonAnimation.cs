...
{
    public class GotfraggonAnimation : SpriteAnimation
    {
        private bool _checkEndSpell = false;
        public GotfraggonAnimation()
        {

        }
        public GotfraggonAnimation(Texture2D Texture, int frames, int animations)
            : base(Texture, frames, animations)
        {
            this.TimeToUpdate = 10F;
        }

        public GotfraggonAnimation(Texture2D texture, StreamReader sr)
            : base(texture, sr)
        {
            this.TimeToUpdate = 8F;
        }
