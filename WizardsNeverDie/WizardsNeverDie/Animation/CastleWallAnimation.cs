...
{
    class CastleWallAnimation: SpriteAnimation
    {
        private bool spell1 = false, spell2 = false;
        public CastleWallAnimation(Texture2D Texture, int frames, int animations)
            : base(Texture, frames, animations)
        {
            this.TimeToUpdate = 5F;
        }

        public CastleWallAnimation(Texture2D texture, StreamReader sr)
            : base(texture, sr)
        {
            this.TimeToUpdate = 5F;
        }
