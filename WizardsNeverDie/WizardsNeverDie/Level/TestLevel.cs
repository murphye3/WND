...
namespace WizardsNeverDie.Level
{
    public class TestLevel : BaseLevel
    {
        ...
        public override void LoadContent()
        {
            ...
            _gotfraggonAnimation = new GotfraggonAnimation(ScreenManager.Content.Load<Texture2D>("Sprites\\Gotfraggon\\gotfraggon"), new StreamReader(@"Content/Sprites/Gotfraggon/gotfraggon.txt"));
            _gotfraggonAnimation.AnimationName = "gotfraggon_dl_walk";
            _gotfraggon = new Gotfraggon(_gotfraggonAnimation, _player, ConvertUnits.ToSimUnits(-(2048 / 2) + 2048 - (380 / 2), -(2048 / 2) + 2048 - (380 / 2)), 1.5f, 1.5f, 10F);
        ...
        public void PurpleSpell(Gotfraggon enemy, int forcePower)
        {
            forcePower = 10000;
            Vector2 plasmaPosition = plasmaPosition = new Vector2(0, _player.Position.Y + 2);
            WizardPlasmaAnimation plasmaSprite = new WizardPlasmaAnimation(ScreenManager.Content.Load<Texture2D>("Sprites\\Plasma\\plasma"), new StreamReader(@"Content/Sprites/Plasma/plasma.txt"));
            ...
            {
                force = new Vector2(-forcePower, 0);
                plasmaPosition = new Vector2(enemy.Position.X - 7, enemy.Position.Y - 5);
            }
            else if (animation.GetOrientation() == Orientation.Right)
            {
                force = new Vector2(forcePower, 0);
            ...
            RangedPurplePlasma purplePlasma = new RangedPurplePlasma(plasmaSprite, plasmaPosition, force);
            _purplePlasma.Add(purplePlasma);
            //}
        ...
        public override void Update(GameTime gameTime, bool otherScreenHasFocus, bool coveredByOtherScreen)
        {
            ...
            GotfraggonAnimation gfAnimation = (GotfraggonAnimation)_gotfraggon.SpriteManager;
            AnimationState gfState = gfAnimation.GetAnimationState();
            if (gfState == AnimationState.Spell1)
            {
                //PurpleSpell(_gotfraggon, forcePower);
            ...
            else if (gfAnimation.CheckEndSpell == true)
            {
                //PurpleSpell(_purpleCreatures[i], 500);
                PurpleSpell(_gotfraggon, forcePower);
                _gotfraggon.Update(gameTime);
            }
            else
            {
                _gotfraggon.Update(gameTime);
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            _gotfraggon.Draw(ScreenManager.SpriteBatch);
